...
ALTER VIEW public.v_storage_policies_by_bucket SET (security_invoker = true);

-- 2. Fix Mutable Search Path on storage_path_company_id
ALTER FUNCTION public.storage_path_company_id(text) SET search_path = public, pg_temp;
