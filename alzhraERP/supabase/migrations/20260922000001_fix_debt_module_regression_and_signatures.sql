...
--
-- ⚠️ لا تُطبَّق هذه الهجرة على قاعدة الإنتاج الحية:
--    تدقيق مباشر (2026-09-22) عبر Management API أثبت أن القاعدة الحية سليمة
--    في كل بنود P0 أدناه (بوابات الأدوار، الحالات الصحيحة، التواقيع الثنائية
--    للتحليلات والمهام، قيدا التفرد، صفر تكرارات)، وأن نسخة
--    get_debt_party_overview الحية تحوّل للعملة الأساس وتعزل الفروع بينما نسخة
--    هذا الملف لا تفعل — أي أن تطبيقه حياً يُرجّع مزايا قائمة.
--    الخلاصة: هذا الملف علاج «إعادة البناء من الصفر» فقط، لأن سلسلة
--    patch_rpc_security_part2/3/4 (2026-09-16) تعيد إدخال الانحدار في مسار
--    الهجرات. الفجوات الحقيقية على الحية عُولجت في
--    20260922000002_debt_analytics_live_alignment.sql
-- ============================================================
