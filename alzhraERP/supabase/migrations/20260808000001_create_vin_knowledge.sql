...
RETURNS TABLE (
    id UUID, canonical_part_name TEXT, category TEXT,
    position TEXT, side TEXT, oem_numbers TEXT[],
    cross_references TEXT[], fitment_status TEXT,
    evidence TEXT, evidence_source TEXT, demand_level TEXT,
    sales_count INTEGER, vehicle_matches INTEGER
)
LANGUAGE sql STABLE SECURITY DEFINER
AS $$
