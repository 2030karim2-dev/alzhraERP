-- ==============================================================================
-- Migration: Increase invoice search limit in search_invoices_advanced RPC
-- Purpose: Allow fetching up to 5,000 invoices and default to 500 instead of 50/100
-- ==============================================================================
...
COMMENT ON FUNCTION public.search_invoices_advanced IS 'دالة بحث متقدم وعميق تدعم التطبيع العربي والبحث بالقطع والأرقام البديلة مع سقف جلب حتى 5000 فاتورة';
