...
begin
  ...
  insert into invoices(
    ...
    issue_date, notes, created_by, currency_code, exchange_rate,
    ...
    p_issue_date, p_notes, v_uid, p_currency, p_exchange_rate,
