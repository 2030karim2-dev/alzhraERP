        ...
        accessor: (item: any) => (
          <div className="flex items-center gap-1.5 text-gray-500">
            ...
            <span className="text-[10px] font-bold">
              {item.last_sale_date
                ? new Date(item.last_sale_date).toLocaleDateString('ar-SA-u-nu-latn')
                : 'لا يوجد مبيعات'}
            </span>
          </div>
        ),
      ...
      },
      {
        ...
        accessor: (item: any) => (
          <div className="flex items-center gap-1.5">
            ...
            <span className="rounded-lg bg-red-100 px-2 py-0.5 text-[10px] font-bold text-red-700 dark:bg-red-900/30 dark:text-red-400">
