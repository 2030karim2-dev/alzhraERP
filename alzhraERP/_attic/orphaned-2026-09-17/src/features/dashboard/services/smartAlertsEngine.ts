...
export const DEFAULT_RULES: AlertRule[] = [
  ...
  },
  {
    id: 'critical-stock',
    name: 'مخزون حرج',
    description: 'تنبيه عند نفاد المخزون',
    type: 'low_stock',
    enabled: true,
    threshold: 0,
    severity: 'critical',
  ...
  },
  {
    id: 'high-debt',
    name: 'مديونية عالية',
    description: 'تنبيه عند تجاوز العميل حد الائتمان',
    type: 'high_debt',
    enabled: true,
    threshold: 10000,
    severity: 'warning',
  ...
  {
    id: 'overdue-7',
    name: 'فواتير متأخرة 7 أيام',
    description: 'تنبيه بالفواتير المتأخرة لأكثر من أسبوع',
  ...
  {
    id: 'overdue-30',
    name: 'فواتير متأخرة 30 يوم',
    description: 'تنبيه بالفواتير المتأخرة لأكثر من شهر',
    type: 'overdue_invoice',
    enabled: true,
    threshold: 30,
    severity: 'critical',
...
export const evaluateAllRules = async (
  ...
  const results = await Promise.all(rules.map(rule => evaluateRule(rule, data)));
