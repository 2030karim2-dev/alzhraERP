...
const QuotationRow = ({ quotation }: { quotation: QuotationListRow }): React.ReactElement => {
  ...
  return (
    <div className="flex items-center justify-between p-3 transition-colors hover:bg-gray-50 dark:hover:bg-slate-800/50">
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-xs text-gray-400">{quotation.item_count} بنود</span>
      </div>
    </div>
  );
};
