    ...
    <div className="space-y-2">
        ...
        {selectedSupplier === null ? (
            <div className="relative">
                ...
                {isDropdownOpen && supplierQuery.length > 1 && <div className="absolute w-full mt-2 bg-[var(--app-surface)] border border-gray-100 dark:border-slate-800 rounded-lg shadow-2xl max-h-48 overflow-y-auto z-10 animate-in fade-in slide-in-from-top-2">
