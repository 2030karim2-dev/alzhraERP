...
const WelcomeSection: React.FC = () => {
    ...
    return (
        <div className="bg-[var(--app-surface)] rounded-3xl max-md:rounded-xl p-6 max-md:p-3 max-md:p-6 shadow-sm border border-[var(--app-border)] mb-6 max-md:mb-3 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 max-md:gap-3">
                <div>
                    <h1 className="text-2xl max-md:text-lg font-bold text-[var(--app-text)] mb-2">
                ...
                <div className="flex items-center gap-2 bg-[var(--app-surface-hover)] px-4 max-md:px-3 py-2 rounded-2xl max-md:rounded-xl border border-[var(--app-border)]">
