...
const BranchSwitcher: React.FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    <div ref={ref} className={cn('relative', className)}>
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute left-0 top-full mt-2 w-56 bg-[var(--app-surface)] border border-gray-200 dark:border-slate-700 rounded-2xl shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
          {/* Header */}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 text-right">
                      ...
                      {branch.address && (
                        <p className="text-[10px] text-gray-400 truncate mt-0.5">{branch.address}</p>
                      )}
                    </div>
