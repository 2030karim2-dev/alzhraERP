    ...
    return (
        <div className="p-3 max-md:p-3 md:p-6 animate-in fade-in duration-500">
            <div className="max-w-4xl mx-auto space-y-4">
                ...
                <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2 max-md:gap-2">
                        ...
                        <button
                            onClick={handleSave}
                            className={cn(
                                "inline-flex items-center gap-2 max-md:gap-2 px-5 py-2 md:py-2.5 rounded-xl text-[10px] md:text-xs font-bold uppercase tracking-widest transition-all active:scale-95 shadow-lg",
                                saved
                            ...
                            <div className="grid grid-cols-3 gap-3 max-md:gap-3">
                                {([
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            "p-3 max-md:p-3 md:p-4 rounded-xl border-2 text-center transition-all",
                ...
                {/* Bottom Info */}
                <div className="p-3 max-md:p-3 md:p-4 bg-indigo-50 dark:bg-indigo-900/10 rounded-xl border border-indigo-100 dark:border-indigo-900/20 flex items-start gap-3 max-md:gap-3">
                    <div className="p-1 max-md:p-1.5 bg-indigo-500 text-white rounded-lg flex-shrink-0 mt-0.5">
                        <Printer size={12} />
                    </div>
                    <div>
