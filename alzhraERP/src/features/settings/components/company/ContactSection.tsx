...
const ContactSection: React.FC<Props> = ({ register }) => (
  <div className="space-y-4">
    <div className="flex items-center gap-1.5 mb-1">
      ...
      <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.15em]">المعلومات المالية والضريبية</h3>
    </div>
    <div className="grid grid-cols-2 gap-4">
      <div className="space-y-1">
        <label className="text-[10px] font-bold text-gray-400 uppercase mr-1">العملة الأساسية</label>
