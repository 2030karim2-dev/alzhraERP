      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ print_header: e.target.checked });
            }}
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ print_footer: e.target.checked });
            }}
            className="h-4 w-4 rounded text-orange-600 focus:ring-orange-500"
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ print_logo: e.target.checked });
            }}
            className="h-4 w-4 rounded text-orange-600 focus:ring-orange-500"
          />
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ print_qr_code: e.target.checked });
            }}
            className="h-4 w-4 rounded text-orange-600 focus:ring-orange-500"
          />
