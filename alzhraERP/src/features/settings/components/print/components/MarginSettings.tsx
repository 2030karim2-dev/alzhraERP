      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <div>
          ...
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ margin_top: parseInt(e.target.value) || 0 });
            }}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ margin_bottom: parseInt(e.target.value) || 0 });
            }}
            className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-[11px] font-bold text-slate-800 outline-none focus:border-transparent focus:ring-2 focus:ring-orange-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ margin_left: parseInt(e.target.value) || 0 });
            }}
            className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-[11px] font-bold text-slate-800 outline-none focus:border-transparent focus:ring-2 focus:ring-orange-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
              handleUpdate({ margin_right: parseInt(e.target.value) || 0 });
            }}
            className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-[11px] font-bold text-slate-800 outline-none focus:border-transparent focus:ring-2 focus:ring-orange-500 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
          />
        </div>
