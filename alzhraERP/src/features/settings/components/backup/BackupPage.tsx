...
const BackupPage: React.FC = () => {
    ...
    return (
        <div className="p-3 max-md:p-3 md:p-6 animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-none mx-auto space-y-6 pb-24">
            <input
                type="file"
                ref={fileInputRef}
            ...
            <div className="flex flex-col lg:flex-row gap-4 max-md:gap-4 items-stretch">
                {/* Main Status Block */}
                <div className="flex-1 bg-slate-950 rounded-[2.5rem] p-8 max-md:p-4 text-white relative overflow-hidden flex flex-col justify-between shadow-2xl border border-white/5">
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 max-md:gap-4 mb-6">
                            <div className="p-3 max-md:p-3 bg-blue-600/20 text-blue-400 rounded-2xl border border-blue-500/30 shadow-lg shadow-blue-500/10">
                                <Database size={28} />
                            </div>
                            <div>
                                <h2 className="text-2xl max-md:text-lg font-bold uppercase tracking-tight">محرك تأمين البيانات</h2>
                                <div className="flex items-center gap-2 max-md:gap-2 mt-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-md:gap-3">
                {/* Automatic Backup Configuration Section */}
                <div className="lg:col-span-2 space-y-4">
                    <div className="flex items-center gap-2 max-md:gap-2 px-2">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border-2 border-gray-100 dark:border-slate-800 p-8 max-md:p-4 shadow-sm space-y-8">
                        ...
                        <div className={cn("grid grid-cols-1 md:grid-cols-2 gap-8 max-md:gap-3 transition-all duration-500", !autoConfig.enabled && "opacity-30 pointer-events-none grayscale")}>
                            <div className="space-y-4">
                                <div className="flex items-center gap-2 max-md:gap-2 text-[10px] font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest px-1">
                                    <Clock size={14} className="text-blue-500" /> دورية النسخ
                                </div>
                                <div className="flex bg-gray-50 dark:bg-slate-950 p-1 max-md:p-1 rounded-2xl border dark:border-slate-800">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-4 max-md:gap-4 bg-gray-50 dark:bg-slate-950 px-4 py-1.5 rounded-2xl border dark:border-slate-800">
                                    <input
            ...
            <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] border-2 border-gray-100 dark:border-slate-800 overflow-hidden shadow-sm">
                ...
                <div className="divide-y dark:divide-slate-800 min-h-[100px] flex flex-col">
                    {logs.length > 0 ? logs.map((log: any) => {
                        ...
                        return (
                            <div key={log.id} className="p-4 max-md:p-4 px-8 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-slate-800/50 transition-colors group">
                                ...
                                <div className="flex items-center gap-8 max-md:gap-3">
                                    ...
                                    <div className={cn(
                                        "flex items-center gap-2 max-md:gap-2 px-3 py-1 rounded-full border",
                                        log.status === 'Success'
