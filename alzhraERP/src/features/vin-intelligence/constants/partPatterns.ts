/**
 * Static automotive parts intelligence dictionaries.
 * OE brand registry, part-number patterns with bilingual labels, and
 * brand-detection heuristics. Pure data — kept out of the service layer.
 */
...
export const PART_PATTERNS: PartPattern[] = [
  {
