...
const CategoryStats: React.FC<Props> = ({ categoriesCount, totalProducts, alertedCategories }) => {
    return (
        <div className="grid grid-cols-3 gap-1.5">
            <div className="bg-[var(--app-surface)] p-2 border border-gray-100 dark:border-slate-800 rounded-none flex items-center gap-2">
                <div className="p-1.5 bg-blue-600 text-white rounded shadow-md"><Layers size={12} /></div>
                <div className="min-w-0">
                    <p className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">الأقسام</p>
            ...
            <div className="bg-[var(--app-surface)] p-2 border border-gray-100 dark:border-slate-800 rounded-none flex items-center gap-2">
                ...
                <div className="min-w-0">
                    <p className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">الأصناف</p>
            ...
            <div className="bg-slate-900 p-2 rounded-none border-r-2 border-amber-500 flex items-center gap-2">
                ...
                <div className="min-w-0">
                    <p className="text-[10px] font-bold text-amber-500 uppercase leading-none mb-0.5">تنبيهات</p>
