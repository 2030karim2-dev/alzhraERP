...
const ImportTemplateCard: React.FC<Props> = ({ onDownload }) => {
    return (
        <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-xl border border-blue-100 dark:border-blue-900/30 flex justify-between items-center">
            ...
            <button 
                onClick={onDownload} 
                className="flex items-center gap-1 text-[10px] font-bold bg-white dark:bg-slate-800 px-3 py-1.5 rounded-lg shadow-sm border border-blue-100 dark:border-blue-900 hover:text-blue-600 transition-colors"
            >
