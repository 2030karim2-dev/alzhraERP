                    ...
                    {!selectedProduct ? (
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="flex gap-1.5">
                                ...
                                />
                                <button onClick={handleSave} disabled={isSaving} className="flex-1 bg-indigo-600 text-white text-[10px] font-bold py-1 hover:bg-indigo-700 transition-colors">
            ...
            <div className="flex-1 overflow-auto">
                <table className="w-full border-collapse">
                    <thead className="sticky top-0 bg-slate-50 dark:bg-slate-900 z-10 border-b border-slate-200 dark:border-slate-800">
                        <tr>
                            <th className="text-right px-4 py-1.5 text-[10px] font-bold text-slate-500 uppercase tracking-tight">القطعة (المكون)</th>
                            <th className="text-right px-4 py-1.5 text-[10px] font-bold text-slate-500 uppercase tracking-tight w-20">الكمية</th>
                        ...
                        {isLoading ? (
                            ...
                            <tr>
                                <td colSpan={3} className="text-center py-10 text-slate-300">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">ليس منتج تجميعي</span>
                                </td>
                            </tr>
                        ) : (
                            kitItems.map((item) => (
