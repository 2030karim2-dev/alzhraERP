...
const ProductMicroCard: React.FC<Props> = ({ product, onClick }) => {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="mb-1 flex items-center justify-between gap-1.5">
              {product.brand && (
                <span className="inline-flex max-w-[130px] items-center gap-1 truncate rounded-md bg-blue-50 px-2 py-0.5 text-[10px] font-bold text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
              ...
              <span
                className={cn(
                  'mr-auto inline-flex shrink-0 items-center gap-0.5 rounded-md px-2 py-0.5 text-[10px] font-bold',
                  isLow
      ...
      <div className="flex items-center justify-between border-t border-slate-100 bg-slate-50/70 px-3.5 py-2.5 dark:border-slate-800/80 dark:bg-slate-900/40">
