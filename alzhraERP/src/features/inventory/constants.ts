...
export const getInventoryTabGroups = (t: (key: string, params?: any) => string): TabGroup[] => [
  ...
  },
  {
    ...
    icon: FileText,
    colorClass:
      'text-emerald-600 bg-emerald-50 border-emerald-100 dark:text-emerald-400 dark:bg-emerald-950/40 dark:border-emerald-900/30',
    tabs: [
...

  {
    ...
    icon: Settings,
    colorClass:
      'text-blue-600 bg-blue-50 border-blue-100 dark:text-blue-400 dark:bg-blue-950/40 dark:border-blue-900/30',
    tabs: [{ id: 'warehouses', label: t('warehouses'), icon: Warehouse }],
  },
];
