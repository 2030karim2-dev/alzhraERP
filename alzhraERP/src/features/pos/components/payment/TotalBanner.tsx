...
export const TotalBanner: React.FC<TotalBannerProps> = ({ total, currency }) => {
    ...
    return (
        <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white px-5 max-md:px-3 py-4 max-md:py-3 text-center relative overflow-hidden">
            ...
            <p dir="ltr" className="text-4xl max-md:text-3xl font-black font-mono tracking-tight">{formatCurrency(total, currency as any)}</p>
