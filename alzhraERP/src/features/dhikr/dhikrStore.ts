...
export const POPULAR_CITIES: PresetCity[] = [
  // ── اليمن ─────────────────────────────────────────────────────────────
  { name: 'شحن - المهرة', country: 'اليمن', lat: 17.535, lng: 52.247 },
  { name: 'الغيضة - المهرة', country: 'اليمن', lat: 16.2078, lng: 52.1764 },
  { name: 'حوف - المهرة', country: 'اليمن', lat: 16.649, lng: 52.957 },
  { name: 'سيحوت - المهرة', country: 'اليمن', lat: 15.207, lng: 51.245 },
  ...
  { name: 'صنعاء', country: 'اليمن', lat: 15.3694, lng: 44.191 },
  ...
  { name: 'سقطرى (حديبو)', country: 'اليمن', lat: 12.65, lng: 54.0167 },
  ...
  { name: 'مسقط', country: 'عمان', lat: 23.588, lng: 58.3829 },
  { name: 'دبي', country: 'الإمارات', lat: 25.2048, lng: 55.2708 },
  { name: 'الدوحة', country: 'قطر', lat: 25.2854, lng: 51.531 },
