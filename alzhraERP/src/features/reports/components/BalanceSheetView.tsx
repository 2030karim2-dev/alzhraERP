...
const BalanceSheetView: React.FC = () => {
    ...
    return (
        <div className="max-w-[1400px] mx-auto space-y-4 sm:space-y-6 pb-10 sm:pb-12 print-area animate-in slide-in-from-bottom-4 duration-700">
            ...
            <MobileCard padding="sm" className="bg-white/70 dark:bg-slate-900/40 relative overflow-hidden flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-none shadow-2xl">
                ...
                <div className="relative z-10 text-right">
                    <div className="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                        <div className="p-2 sm:p-2.5 bg-slate-900 text-white rounded-xl sm:rounded-2xl shadow-xl hover:rotate-6 transition-transform">
                            <Landmark size={20} />
                        </div>
                    ...
                    <p className="text-[10px] sm:text-xs text-slate-400 font-bold uppercase tracking-wider flex items-center gap-2">
                        <Clock size={12} />
                ...
                <div className="flex items-center gap-3 sm:gap-6 relative z-10">
                    ...
                    <ShareButton
                        ...
                        className="bg-slate-900 text-white hover:bg-slate-800 rounded-2xl p-3 sm:p-4 shadow-xl transition-all"
            ...
            <MobileCard padding="sm" className={cn(
                ...
                <div className="flex items-center gap-3 sm:gap-4 relative z-10">
                    <div className={cn("p-2 sm:p-3 rounded-full", isBalanced ? "bg-emerald-500 text-white shadow-lg shadow-emerald-500/30" : "bg-rose-500 text-white shadow-lg shadow-rose-500/30")}>
                        <ShieldCheck size={20} />
                    </div>
                    <div>
