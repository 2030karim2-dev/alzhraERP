  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-6 duration-1000 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6  max-md:gap-3">
        {/* Cost Value Card */}
        <div className="glass-panel bento-item p-8  max-md:p-4 bg-blue-600 dark:bg-blue-900/40 text-white shadow-2xl shadow-blue-500/30 relative overflow-hidden group border-none min-h-[220px] flex flex-col justify-between">
          <div className="absolute top-0 right-0 p-6  max-md:p-3 opacity-20 transform group-hover:rotate-12 group-hover:scale-120 transition-all duration-700">
            <Wallet size={100} />
          </div>
          <div className="relative z-10">
            <p className="text-[10px] font-bold uppercase text-blue-100 tracking-[0.3em] mb-3">القيمة الرأسمالية (بالتكلفة)</p>
            <h2 dir="ltr" className="text-4xl  max-md:text-2xl font-bold font-mono tracking-tighter drop-shadow-2xl">{formatCurrency(costValue)}</h2>
          </div>
        ...
        {/* Market Value Card */}
        <div className="glass-panel bento-item p-8  max-md:p-4 bg-emerald-600 dark:bg-emerald-900/40 text-white shadow-2xl shadow-emerald-500/30 relative overflow-hidden group border-none min-h-[220px] flex flex-col justify-between">
          <div className="absolute top-0 right-0 p-6  max-md:p-3 opacity-20 transform group-hover:rotate-12 group-hover:scale-120 transition-all duration-700">
            <Coins size={100} />
          </div>
          <div className="relative z-10">
            <p className="text-[10px] font-bold uppercase text-emerald-100 tracking-[0.3em] mb-3">القيمة البيعية السوقية</p>
            <h2 dir="ltr" className="text-4xl  max-md:text-2xl font-bold font-mono tracking-tighter drop-shadow-2xl">{formatCurrency(marketValue)}</h2>
          </div>
          <div className="relative z-10 flex items-center   max-md:gap-2">
        ...
        <div className="glass-panel bento-item p-8  max-md:p-4 bg-slate-900 dark:bg-slate-950 text-white shadow-2xl relative overflow-hidden group border-none min-h-[220px] flex flex-col justify-between">
          <div className="absolute bottom-0 right-0 p-6  max-md:p-3 opacity-10 transform group-hover:-translate-y-4 group-hover:scale-110 transition-all duration-1000">
            <TrendingUp size={120} />
          </div>
          <div className="relative z-10">
            ...
            <h2 dir="ltr" className="text-4xl  max-md:text-2xl font-bold font-mono tracking-tighter text-amber-500 drop-shadow-2xl italic">+{formatCurrency(profit)}</h2>
          </div>
      ...
      <div className="glass-panel bento-item bg-white dark:bg-slate-900/50 border-none shadow-2xl p-10  max-md:p-5 flex flex-col lg:flex-row   max-md:gap-16 items-center overflow-hidden">
        ...
        <div className="flex-1 space-y-10 w-full lg:border-r lg:dark:border-slate-800 lg:pr-16 lg:rtl:pr-0 lg:rtl:pl-16">
          <div className="space-y-4">
            <h3 className="text-3xl max-md:text-xl font-bold text-slate-800 dark:text-white tracking-tight leading-tight">
          ...
          <div className="grid grid-cols-2 gap-6  max-md:gap-3">
            <div className="glass-card p-6  max-md:p-3 bg-slate-50 dark:bg-slate-800/40 rounded-3xl max-md:rounded-xl border border-slate-100 dark:border-slate-700/50 hover:bg-white dark:hover:bg-slate-800 transition-all group">
              <div className="flex items-center   max-md:gap-3 mb-3">
                <div className="  max-md:p-2 bg-blue-500 text-white rounded-xl shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform">
                  <Target size={16} />
                </div>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">مجموع الأصناف</span>
              </div>
              <h4 className="text-2xl max-md:text-lg font-bold text-slate-900 dark:text-white font-mono tracking-tighter">
            ...
            <div className="glass-card p-6  max-md:p-3 bg-slate-50 dark:bg-slate-800/40 rounded-3xl max-md:rounded-xl border border-slate-100 dark:border-slate-700/50 hover:bg-white dark:hover:bg-slate-800 transition-all group">
              <div className="flex items-center   max-md:gap-3 mb-3">
                <div className="  max-md:p-2 bg-emerald-500 text-white rounded-xl shadow-lg shadow-emerald-500/20 group-hover:scale-110 transition-transform">
                  <Activity size={16} />
                </div>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">معدل الدقة</span>
              </div>
              <h4 className="text-2xl max-md:text-lg font-bold text-emerald-500 font-mono tracking-tighter">
