...
const JournalTable: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            {/* Controls Bar */}
            <div className="flex flex-col md:flex-row  max-md:gap-4 justify-between items-center bg-white dark:bg-slate-900  max-md:p-4 rounded-lg border border-gray-100 dark:border-slate-800 shadow-sm sticky top-0 z-10">
                ...
                <div className="flex items-center  max-md:gap-2 w-full md:w-auto">
                    <button
                        onClick={() => setSortOrder(prev => prev === 'asc' ? 'desc' : 'asc')}
                        className="flex items-center  max-md:gap-2 px-3 py-2 bg-gray-50 dark:bg-slate-800 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors text-sm font-bold"
                    >
                        <ArrowUpDown size={16} />
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg border border-gray-300 dark:border-slate-700 shadow-sm overflow-hidden">
                    ...
                    <table className="w-full text-sm border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                            {filteredJournals.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan={9} className="p-8 max-md:p-4 text-center text-gray-500">
                ...
                {hasNextPage && (
                    <div className=" max-md:p-4 text-center border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800/50">
                        <button
                            onClick={() => fetchNextPage()}
                            disabled={isFetchingNextPage}
                            className="px-6 max-md:px-3 py-2 bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-900/60 rounded-lg text-sm font-bold transition-colors disabled:opacity-50"
                        >
