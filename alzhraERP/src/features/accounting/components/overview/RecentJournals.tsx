...
const RecentJournals: React.FC = () => {
  ...
  if (isLoading) {
    return <div className="p-10 max-md:p-5 text-center"><Loader2 className="animate-spin" /></div>;
  }

  return (
    <div className="bg-white dark:bg-slate-900 rounded-none border border-gray-100 dark:border-slate-800  max-md:p-3 shadow-sm">
      <h3 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 px-1 flex items-center  max-md:gap-2">
