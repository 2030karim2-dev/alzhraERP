...
export const RecurringExpenseSection: React.FC<RecurringExpenseSectionProps> = ({ register, isRecurring }) => {
    return (
        <div className="p-5 border-b dark:border-slate-800 bg-[var(--app-surface)]">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-bold text-gray-400 uppercase">Automated Recurring Expense</p>
                    </div>
                </div>
            ...
            {isRecurring && (
                <div className="grid grid-cols-2 gap-4 animate-in slide-in-from-top-2 duration-300">
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold text-gray-400 uppercase px-1">تكرار كل</label>
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold text-gray-400 uppercase px-1">تاريخ انتهاء التكرار</label>
