...
const invoices: Invoice[] = [
    {
        ...
        payment_method: 'cash',
        invoice_items: [
            { id: 'line-1', product_id: 'product-1', description: 'منتج أول', quantity: 10, unit_price: 100, total: 1000, cost_price: 60 },
            { id: 'line-2', product_id: 'product-2', description: 'منتج ثان', quantity: 5, unit_price: 200, total: 1000, cost_price: 120 },
        ],
    },
];
...
const renderStep = (initialValues: Record<string, unknown> = {}) => {
    ...
    return render(<ReturnItemsStep invoices={invoices} isLoadingInvoices={false} />, { wrapper: Wrapper });
};
...
describe('ReturnItemsStep', () => {
    it('زر "إرجاع كامل الفاتورة" يحدد كل الأصناف بالكميات الكاملة وتظهر في الحقول', () => {
        renderStep();
        selectInvoice();
        ...
        fireEvent.click(screen.getByText('إرجاع كامل الفاتورة'));

        // الكميات الكاملة (10 و 5) تظهر في حقول الإرجاع — كان هذا لا يعمل
        // بسبب عدم تطابق المفتاح (product_id مقابل id)
