...
const InvoiceTotals: React.FC<InvoiceTotalsProps> = ({ notes, onNotesChange }) => {
    ...
    return (
        <div className="p-2 max-md:p-2 md:p-3 bg-[var(--app-surface)] border-t-2 border-gray-100 dark:border-slate-800">
            <div className="flex justify-between items-stretch">
                ...
                <div className="w-full md:w-80 flex flex-col border-l dark:border-slate-800">
                    <div className={cn("grid", discountEnabled ? "grid-cols-2" : "grid-cols-1")}>
                        <div className="p-3 max-md:p-3 border-b dark:border-slate-800 text-right">
                            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block">المجموع الفرعي</span>
                        ...
                        {discountEnabled && (
                            <div className="p-3 max-md:p-3 border-b border-l dark:border-slate-800 text-right">
                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest block">إجمالي الخصم</span>
                    ...
                    <div className="bg-slate-950 text-white p-4 max-md:p-4 flex justify-between items-center relative overflow-hidden group flex-1">
                        <div className="relative z-10">
                            <span className="text-[10px] font-bold text-blue-400 uppercase tracking-[0.2em] block mb-1">صافي الفاتورة</span>
                            <h2 dir="ltr" className="text-4xl max-md:text-2xl font-bold font-mono tracking-tighter group-hover:scale-105 transition-transform duration-500 leading-none">
                                {formatCurrency(summary.totalAmount, currency)}
                            </h2>
                        </div>
                        <div className="relative z-10 p-3 max-md:p-3 bg-blue-600 rounded-none shadow-lg shadow-blue-500/40">
                            <Wallet size={20} />
                        </div>
