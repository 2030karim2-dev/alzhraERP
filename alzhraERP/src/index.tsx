  ...
  caches
    ...
    .then(keys => {
      const stale = keys.filter(
        k => k.startsWith('workbox-') || k.startsWith('vite-plugin-pwa') || k === 'app-shell'
      );
...
const SupabaseSetupErrorScreen: React.FC = () => (
  ...
  >
    ...
    >
      <h1 style={{ fontSize: 20, fontWeight: 800, margin: '0 0 12px', color: '#f8fafc' }}>
        تعذر الاتصال بقاعدة البيانات
      </h1>
      <p style={{ fontSize: 14, lineHeight: 1.8, whiteSpace: 'pre-line', margin: '0 0 16px' }}>
      ...
      <p style={{ fontSize: 12, color: '#94a3b8', margin: 0 }}>
        إذا كنت المطوّر، راجع README أو اتصل بمسؤول النظام.
      </p>
    </div>
  </div>
);
