...
const ITEM_THEMES: Record<string, ItemTheme> = {
  dashboard: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-purple-600 to-indigo-600 text-white shadow-md shadow-purple-500/30 ring-2 ring-purple-400/30',
    activeItemBg:
      'bg-purple-500/10 dark:bg-purple-500/15 border-purple-200 dark:border-purple-800/60',
    activeItemText: 'text-purple-950 dark:text-purple-100 font-black',
    hoverBadge:
      'group-hover:scale-110 group-hover:bg-purple-500/20 dark:group-hover:bg-purple-500/30',
  },
  chat: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-blue-600 to-cyan-600 text-white shadow-md shadow-blue-500/30 ring-2 ring-blue-400/30',
  ...
  bonds: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-amber-600 to-orange-600 text-white shadow-md shadow-amber-500/30 ring-2 ring-amber-400/30',
    ...
    hoverBadge:
      'group-hover:scale-110 group-hover:bg-amber-500/20 dark:group-hover:bg-amber-500/30',
  },
  debts: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-rose-600 to-pink-600 text-white shadow-md shadow-rose-500/30 ring-2 ring-rose-400/30',
  ...
  clients: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-teal-600 to-emerald-600 text-white shadow-md shadow-teal-500/30 ring-2 ring-teal-400/30',
  ...
  suppliers: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-indigo-600 to-purple-600 text-white shadow-md shadow-indigo-500/30 ring-2 ring-indigo-400/30',
    activeItemBg:
      'bg-indigo-500/10 dark:bg-indigo-500/15 border-indigo-200 dark:border-indigo-800/60',
    activeItemText: 'text-indigo-950 dark:text-indigo-100 font-black',
    hoverBadge:
      'group-hover:scale-110 group-hover:bg-indigo-500/20 dark:group-hover:bg-indigo-500/30',
  },
  supplier_portal: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-cyan-600 to-blue-600 text-white shadow-md shadow-cyan-500/30 ring-2 ring-cyan-400/30',
  ...
  inventory: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-orange-600 to-amber-600 text-white shadow-md shadow-orange-500/30 ring-2 ring-orange-400/30',
    activeItemBg:
      'bg-orange-500/10 dark:bg-orange-500/15 border-orange-200 dark:border-orange-800/60',
    activeItemText: 'text-orange-950 dark:text-orange-100 font-black',
    hoverBadge:
      'group-hover:scale-110 group-hover:bg-orange-500/20 dark:group-hover:bg-orange-500/30',
  },
  expenses: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-red-600 to-rose-600 text-white shadow-md shadow-red-500/30 ring-2 ring-red-400/30',
  ...
  accounting: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-violet-600 to-purple-600 text-white shadow-md shadow-violet-500/30 ring-2 ring-violet-400/30',
    activeItemBg:
      'bg-violet-500/10 dark:bg-violet-500/15 border-violet-200 dark:border-violet-800/60',
    activeItemText: 'text-violet-950 dark:text-violet-100 font-black',
    hoverBadge:
      'group-hover:scale-110 group-hover:bg-violet-500/20 dark:group-hover:bg-violet-500/30',
  },
  commissions: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-fuchsia-600 to-pink-600 text-white shadow-md shadow-fuchsia-500/30 ring-2 ring-fuchsia-400/30',
    activeItemBg:
      'bg-fuchsia-500/10 dark:bg-fuchsia-500/15 border-fuchsia-200 dark:border-fuchsia-800/60',
    activeItemText: 'text-fuchsia-950 dark:text-fuchsia-100 font-black',
    hoverBadge:
      'group-hover:scale-110 group-hover:bg-fuchsia-500/20 dark:group-hover:bg-fuchsia-500/30',
  },
  pos: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-pink-600 to-rose-600 text-white shadow-md shadow-pink-500/30 ring-2 ring-pink-400/30',
  ...
  vin: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-sky-600 to-blue-600 text-white shadow-md shadow-sky-500/30 ring-2 ring-sky-400/30',
  ...
  reports: {
    ...
    iconColor: 'text-blue-600 dark:text-blue-400',
    activeBadge:
      'bg-gradient-to-tr from-blue-600 to-indigo-600 text-white shadow-md shadow-blue-500/30 ring-2 ring-blue-400/30',
    activeItemBg: 'bg-blue-500/10 dark:bg-blue-500/15 border-blue-200 dark:border-blue-800/60',
    activeItemText: 'text-blue-950 dark:text-blue-100 font-black',
    hoverBadge: 'group-hover:scale-110 group-hover:bg-blue-500/20 dark:group-hover:bg-blue-500/30',
  },
  settings: {
    ...
    activeBadge:
      'bg-gradient-to-tr from-slate-700 to-slate-900 dark:from-slate-600 dark:to-slate-800 text-white shadow-md shadow-slate-500/30 ring-2 ring-slate-400/30',
    ...
    hoverBadge:
      'group-hover:scale-110 group-hover:bg-slate-500/20 dark:group-hover:bg-slate-500/30',
  },
};
...
const SidebarNav: React.FC<SidebarNavProps> = ({ isCollapsed }) => {
  ...
  return (
    <nav className="scrollbar-hide flex-1 space-y-1.5 overflow-y-auto px-2 py-3">
      {filteredItems.map(item => {
        ...
        return (
          <button
            ...
            className={cn(
              'group relative flex w-full items-center gap-3 rounded-xl border px-2.5 py-2 text-start text-xs font-bold transition-all duration-200',
              isActive
                ? cn(theme.activeItemBg, 'shadow-sm')
                : 'border-transparent text-slate-600 hover:bg-slate-100/70 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-slate-800/50 dark:hover:text-slate-100',
          ...
          >
            ...
            {isActive && (
              <span
                className={cn(
                  'absolute bottom-2 right-0 top-2 w-1 rounded-l-full',
            ...
            <div
              className={cn(
                'flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border shadow-xs transition-all duration-200',
                isActive
                  ? theme.activeBadge
            ...
            {!isCollapsed && (
              <span
                className={cn(
                  'overflow-hidden whitespace-nowrap transition-transform duration-200 group-hover:translate-x-0.5',
                  isActive
