...
const MainLayout: React.FC = () => {
  ...
  const moreItems = [
    ...
    { icon: Calculator, label: 'عمولات المهندسين', path: ROUTES.DASHBOARD.COMMISSIONS },
    {
      icon: SlidersHorizontal,
      label: 'إعدادات العمولات',
      path: ROUTES.DASHBOARD.COMMISSIONS_CONFIG,
    },
    { icon: Link2, label: 'توزيعات المهندسين', path: ROUTES.DASHBOARD.COMMISSIONS_ASSIGNMENTS },
    { icon: CalendarDays, label: 'دورة حياة الفترات', path: ROUTES.DASHBOARD.COMMISSIONS_PERIODS },
    { icon: BarChart3, label: 'تقارير العمولات', path: ROUTES.DASHBOARD.COMMISSIONS_REPORTS },
