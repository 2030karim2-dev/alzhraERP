...
const colorClasses: Record<IconColor, { normal: string; groupHover: string }> = {
  ...
  green: {
    ...
    groupHover: 'group-hover:text-emerald-600 dark:group-hover:text-emerald-400',
  },
  blue: {
  ...
  sky: {
    normal: 'text-sky-500',
    groupHover: 'group-hover:text-sky-600 dark:group-hover:text-sky-400',
  },
  orange: {
  ...
  red: {
    normal: 'text-red-500',
    groupHover: 'group-hover:text-red-600 dark:group-hover:text-red-400',
  },
  indigo: {
  ...
  yellow: {
    ...
    groupHover: 'group-hover:text-yellow-600 dark:group-hover:text-yellow-400',
  },
  emerald: {
    normal: 'text-emerald-500',
    groupHover: 'group-hover:text-emerald-600 dark:group-hover:text-emerald-400',
...
const Icon: React.FC<IconProps> = ({ icon: LucideIcon, color = 'slate', className, size = 16 }) => {
  ...
  return (
    <LucideIcon
      size={size}
      className={cn('transition-colors duration-200', theme.normal, theme.groupHover, className)}
    />
  );
};
