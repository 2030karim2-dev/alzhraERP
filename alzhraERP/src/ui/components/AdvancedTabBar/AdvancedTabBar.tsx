...
const TabButton: React.FC<TabButtonProps> = ({
  ...
  return (
    ...
    >
      {/* Icon */}
      {Icon && <Icon className="advanced-tab__icon" aria-hidden="true" />}

      {/* Label */}
      <span className="advanced-tab__label">{tab.label}</span>
        ...
        <div
          ...
          style={{
            left: dragState.dropTargetId
              ? `${indicatorPosition.x + indicatorPosition.width}px`
              : '0',
          }}
        />
